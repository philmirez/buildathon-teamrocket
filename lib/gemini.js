...
/**
 * Plain text generation. Accepts a raw `parts` array for multimodal input
 * (e.g. a PDF as inlineData) — plain text output is used rather than a JSON
 * schema because long documents escape badly and risk truncation.
 */
