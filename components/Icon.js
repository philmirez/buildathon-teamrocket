...
const PATHS = {
  ...
  camera: (
    <>
      <path d="M3 8.5A2 2 0 0 1 5 6.5h2.2l1.2-2h7.2l1.2 2H19a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2Z" />
  ...
  globe: (
    <>
      ...
      <path d="M12 3.4c-2.2 2.3-3.4 5.4-3.4 8.6s1.2 6.3 3.4 8.6c2.2-2.3 3.4-5.4 3.4-8.6S14.2 5.7 12 3.4Z" />
    </>
  ),
  linkedin: (
    <>
